(function () {
    ...
    passwordindicator.$inject = ['CustomerConnect'];

    function passwordindicator(CustomerConnect) {
        // Usage:
        ...
        var directive = {
            ...
            link: link,
            restrict: 'EA',
            templateUrl: 'Components/Shared/PasswordIndicator/PasswordIndicatorView.html'
        };
        return directive;
